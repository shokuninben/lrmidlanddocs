...
| # | Step | Description |
|------------|------------|------------|
| 1| Open Azure File Explorer | Launch and open Azure File Explorer at your local machine. <br />  View Azure File Explorer official software logo / icon [here](img/azure_file_explorer.png) |
